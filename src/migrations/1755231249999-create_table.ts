...
export class CreateTable1755231249999 implements MigrationInterface {
    name = 'CreateTable1755231249999'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "permission" ("id" character varying NOT NULL, "description" character varying, "path" character varying NOT NULL, "method" character varying NOT NULL DEFAULT 'GET', "screen_code" character varying, CONSTRAINT "PK_3b8b97af9d9d8807e41e6f48362" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "role" ("id" character varying NOT NULL, "description" character varying, "group" character varying NOT NULL, CONSTRAINT "PK_b36bcfe02fc8de3c57a8b2391c2" PRIMARY KEY ("id"))`);
